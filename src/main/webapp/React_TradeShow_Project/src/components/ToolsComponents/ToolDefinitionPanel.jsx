...
export default function ToolDefinitionPanel({ tool, onClose }) {
    const [copied, setCopied] = useState(false);

    const handleCopy = () => {
        navigator.clipboard.writeText(JSON.stringify(tool.jsonSchema, null, 2));
        setCopied(true);
            ...
            <div className={ToolsStyles.panelContent}>
                ...
                <section className={ToolsStyles.panelSection}>
                    ...
                    <pre className={ToolsStyles.jsonSchema}>
                        <code>{JSON.stringify(tool.jsonSchema, null, 2)}</code>
                    </pre>
                </section>
                ...
                <section className={ToolsStyles.panelSection}>
                    ...
                    <div className={ToolsStyles.actionButtons}>
                        <button className={ToolsStyles.primaryBtn}>
                            <MdPlayArrow />
                            Test Tool
                        </button>
